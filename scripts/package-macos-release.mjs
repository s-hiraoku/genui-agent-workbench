...
async function main() {
  ...
  await fs.writeFile(
    ...
    [
      ...
      "   This allows the unsigned developer-preview app through Gatekeeper.",
      "3. Install the CLI:",
      "   mkdir -p ~/.local/bin",
      ...
      "   genui prompt-spec",
      "",
      "If genui doctor --start times out, repeat step 2 and then run:",
      "   genui doctor --json",
      "",
      "For bulky rows or time series, keep data in JSON and pass:",
      "   genui popup --openui-lang-file ui.openui --context-file data.json",
      "",
